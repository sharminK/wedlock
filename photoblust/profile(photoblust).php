...
<html lang="en">
  <head>
	...
	<body>
		...
		<form action="edit(photoblust).php?email=".$email" method="POST">
			<div class="container">
			  <div class="row">
				<div class="col-md-2">         
				</div>
				<div class="col-md-9">
				  <h1>Photoblust Company Information</h1>
				  <hr>
				  <table class="table">
					<tr>
					  <th width="150" class="text-right">Photo Comp. Name:</th>
					  <td><?php echo $photoblust_info['pname']; ?></td>
					</tr>
					<tr>
					  <th width="150" class="text-right">Location :</th>
					  <td><?php echo $photoblust_info['ploc']; ?></td>
					</tr>
					
					<tr>
					  <th width="150" class="text-right">Price :</th>
					  <td><?php echo $photoblust_info['pprice']; ?></td>
					</tr>
					
					<tr>
					  <th width="150" class="text-right">Description :</th>
					  <td><?php echo $photoblust_info['pdes']; ?></td>
					</tr>
					
					<tr>
					  <th width="150" class="text-right">Phone Number :</th>
					  <td><?php echo $photoblust_info['pph']; ?></td>
					</tr>
					<tr>
					  <th width="150" class="text-right">Email:</th>
					  <td><?php echo $photoblust_info['email']; ?></td>
					</tr>
					
					<tr>
					  <th width="150" class="text-right">User Name :</th>
					  <td><?php echo $photoblust_info['puser']; ?></td>
					</tr>
					
					<tr>
					  <th width="150" class="text-right">Password:</th>
					  <td><?php echo $photoblust_info['pass']; ?></td>
					</tr>
				  </table>			
				</div>
			  </div>
